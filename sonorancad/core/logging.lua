...
local ErrorCodes = {
    ...
    ['CIVREG_TEMPLATE_FAILED'] = { code = "ERR-CR-101", message = "The live CAD character template could not be loaded. Try again in a moment." },
    ['CIVREG_SUBMISSION_INVALID'] = { code = "ERR-CR-102", message = "The character registration form expired or contained invalid data. Reopen /civreg and try again." },
    ...
    ['BODYCAM_BEEP_FREQUENCY_INVALID'] = { code = "ERR-BC-121", message = "Bodycam beep frequency must be a whole number from 1 to 3600 seconds." },
