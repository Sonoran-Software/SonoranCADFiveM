...
Run the standalone regression tests from the repository root with `lua .codex/tests/civreg_registration_spec.lua`, `lua .codex/tests/civreg_database_sync_spec.lua`, `lua .codex/tests/civreg_framework_selection_spec.lua`, and `lua .codex/tests/linking_account_uuid_spec.lua` (Lua 5.4 or newer). They stub the FiveM, CAD, and SQL boundaries and do not connect to a live CAD community or database.
